...
<footer id="footer" class="footer">
  ...
  <div class="credits">
    ...
    Designed by <a href="https://goprimehost.com/" target="_blank">Goprimehost </a>
  </div>
</footer><!-- End Footer -->
<style>
  .credits {
...
<script>
  document.addEventListener("DOMContentLoaded", function () {
    ...
    const updateDropZoneDisplay = () => {
      dropZone.textContent = allFiles.map(file => file.name).join(', ') || 'Drag & Drop Images Here or Click to Upload';
    };
    ...
    dropZone.addEventListener("drop", (e) => {
      ...
      allFiles = allFiles.concat(droppedFiles); // Accumulate files
    ...
    fileInput.addEventListener("change", () => {
      allFiles = allFiles.concat(Array.from(fileInput.files)); // Add selected files
      updateDropZoneDisplay();
      updateFileInput();
    });
  });
