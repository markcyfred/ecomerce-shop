...
$sql = "SELECT p.*, pi.image_path, pi.alt_text, ($scoreSql) AS score
        FROM products p
...
if (!empty($product['image_path'])) {
    echo "<img src='" . htmlspecialchars($product['image_path']) . "' alt='" . htmlspecialchars($product['alt_text'] ?? $product['product_name']) . "' style='max-width:120px;max-height:120px;border-radius:8px;object-fit:cover;margin-top:10px;'>";
}
