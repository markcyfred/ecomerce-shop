                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="code.php" method="POST" enctype="multipart/form-data" class="row g-3">
                            ...
                            <!--sale_out_limit -->
                            <div class="col-md-4">
                                <label for="inputSaleOutLimit" class="form-label">Sale Out Limit</label>
                                <div class="input-group">
                                    <select class="form-select" id="limitType" onchange="toggleSaleOutInput(this.value)">
                                        <option value="number">Set Limit</option>
                                        <option value="none">No Limit</option>
                                    </select>
                                    <input type="number" class="form-control" id="inputSaleOutLimit" name="sale_out_limit" placeholder="Enter Limit">
                                </div>
